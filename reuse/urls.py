...
path('profile/<slug:user_name_slug>/chat/', views.chat, name='chat'),
...
path('cat/<slug:category_name_slug>/<slug:subcategory_name_slug>/<slug:product_name_slug>/add_to_wishlist/', views.add_to_wishlist, name='add_to_wishlist'),
...
path('chat_with/<slug:user_name_slug>/', views.chat_with, name='chat_with'),
path('chat/<slug:chat_name_slug>/', views.chat_open, name='chat_open'),
