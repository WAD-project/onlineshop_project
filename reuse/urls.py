...
#path('<slug:category_name_slug>/<slug:subcategory_name_slug>/<slug:product_name_slug>/manage_product/', views.manage_product, name='manage_product'),
#path('<slug:category_name_slug>/<slug:subcategory_name_slug>/<slug:product_name_slug>/sell_product/', views.sell_product, name='sell_product'),
